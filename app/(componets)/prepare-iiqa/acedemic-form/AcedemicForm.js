  ...
  return (
    <>
      <div className="panel panel-primary card border p-4 mt-1">
        <div className="panel-heading p-3 text-white bg-[#468cc9]">
        ...
        <div className="bg-blue-200 card mt-4 py-2">
          ...
          <form className="p-4" onSubmit={addProgram}>
            <table
              className={`w-full table-auto border-collapse border border-blue-500 ${
            ...
            >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td
                    className={`border border-l-0 border-blue-500 p-2 ${
                      program.length > 0 && "border-b-0"
                    }`}
                  >
                    ...
                    <div className="text-right">
                      <button
                        className="w-auto mt-2 p-1 bg-blue-500 text-white rounded cursor-pointer"
                        type="submit"
                      >
                        ADD
                      </button>
              ...
              {selfDoc ? (
                <>
                  <a
                    ...
                    href={`${config.BASE_URL}/files/view/${selfDoc}`}
                    target="_blank"
                  >
                    View Document
                  </a>
                      ...
                      <div className="flex align-middle m-auto">
                        {mou.document ? (
                          <div className="flex ">
                            <a
                              className="cursor-pointer my-auto ml-2"
                              href={`${config.BASE_URL}/files/view/${mou.document}`}
                              target="_blank"
                            >
                              View Document
                            </a>
      ...
      <div className="text-right">
        <button
          type="button"
          className="text-right mt-3 mr-5 mb-3 btn p-2 rounded-md text-white bg-[#3c8dbc]"
